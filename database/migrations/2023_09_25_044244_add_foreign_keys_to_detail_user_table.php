...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('detail_user', function (Blueprint $table) {
            ...
            $table->foreign('tipe_user_id', 'fk_detail_user_to_tipe_user')->references('id')->on('tipe_user')->onUpdate('CASCADE')->onDelete('CASCADE');
        });
    }
    ...
    public function down()
    {
        Schema::table('detail_user', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_detail_user_to_tipe_user');
        });
    }
};
